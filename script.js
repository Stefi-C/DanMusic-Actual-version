...
/*---------------------------------------------------------------musicPlayer*/
        ...
        function loadMusic(indexNumb){
          ...
          musicImg.src = `/assets/images/${listMusic[indexNumb - 1].src}.jpeg`;
     ...
     /* case "shuffle_on":
        ...
        for (let i = 0; i < listMusic.length; i++) {
          ...
          let liTag = `<li li-index="${i + 1}">
                        <img src="assets/images/${listMusic[i].src}.jpeg" alt="">
                        <div class="row">
...
*/
      ...
      //----------------contact button
      const contactInfoBtn = document.getElementById('#info-btn');
      ...
      contactInfoBtn.addEventListener("click", (e)=>{
        for(let i = 0; i < serviceBox.length; i++){
            let openInfo = serviceBox[i];
            if(openInfo.classList.contains('active')){
